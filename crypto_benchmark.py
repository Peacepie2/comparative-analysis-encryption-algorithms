...
Compares: AES-256 (GCM), RSA-2048 (Hybrid), ChaCha20
=============================================================================
"""
...
ALGORITHMS    = ["AES-256-GCM", "RSA-2048-Hybrid", "ChaCha20-Poly1305"]
...
def main():
    ...
    print("  Algorithms : AES-256-GCM | RSA-2048-Hybrid | ChaCha20")
